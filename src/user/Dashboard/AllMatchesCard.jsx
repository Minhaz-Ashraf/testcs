...
const AllMatchesCard = ({profileDetails, setIsBlockedUser}) => {
 ...
 console.log(profileDetails, "makl")
  return (
    <div
      className="  shadow rounded-lg flex flex-col md:px-3  justify-between items-center md:w-auto w-[50vh]  sm:w-[70%] "
    >
    {isOpenPop &&
      <span className="absolute">
       <BlockPop setIsOpen={setIsOpenPop} closeblockPop = {closeblockPop} cardId={profileDetails._id} blockUser={blockUser}/>
       </span>}
      <img
