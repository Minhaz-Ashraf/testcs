  ...
  {isLogoutOpen && (
    ...
    >
      <div className="bg-white pb-9  rounded-lg md:w-[38%] w-full  relative p-9  ">
                       ...
                       <p className='text-center font-DMsans text-black font-semibold text-[16px]'>Do you want to Logout your profile ?</p>
                       <div className='flex justify-center items-center font-DMsans gap-5 mt-5'>
                        <span onClick={closeLogout} className='px-8 py-2 cursor-pointer  rounded-lg text-primary border border-primary'>No</span>
                        <span onClick={() => {
  handleLogout();
  closeLogout();
}} className='px-8 py-2 cursor-pointer rounded-lg text-white bg-primary'>Yes</span>
                       </div>
                    </div>
                </div>
            )}
